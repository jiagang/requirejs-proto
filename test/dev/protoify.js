define(['ByteBuffer'], function(ByteBuffer) {
            ...
            case 'object':
                ...
                if (Object.prototype.toString.call(val) === "[object Array]") {
                    ...
                    for (var i=0; i<val.length; ++i)
                        arr['values'][i] = _protoify(val[i], JS);
                    return new JS.Value({ 'array': arr });
                }
                var obj = new JS.Object();
                for (var key in val)
                    if (val.hasOwnProperty(key))
                        obj['keys'].push(_protoify(key, JS)),
                            obj['values'].push(_protoify(val[key], JS));
     ...
     * @expose
     */
    function exports(json, JS) {
        return _protoify(json, JS)     // Returns the root JS.Value
     ...
     * @expose
     */
    exports.parse = function(proto, JS) {
     ...
     * @expose
     */
    exports.performMaintenance = function() {
